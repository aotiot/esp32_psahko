...
// Aikasiirto ja kesäaikatarkistus
...
// LED-matriisin muunnos (xy → lineaarinen indeksi)
int xyToIndex(int x, int y) {
  return (y % 2 == 0) ? y * LED_WIDTH + x : y * LED_WIDTH + (LED_WIDTH - 1 - x);
}

// Aikasynkronointi NTP:llä
void syncTime() {
...
// Näyttö: meneillään oleva + 4 tulevaa tuntia
void showLivePrices() {
...
// Toistuva päivitys (30 min välein)
void loop() {
  delay(30 * 60 * 1000);
  showLivePrices();
}
